                        ...
                        <div class="header-bottom">
                            <div class="header-right w3agile">
                                <div class="header-left-bottom agileinfo">
                                    <form action="php_scripts/inserisci_docente.php" method="POST">
                                        <table class="formtable">
                                            ...
                                            <tr>
                                                <td colspan="5" rowspan="2" style="padding-bottom: 10px;">
                                                    ...
                                                    <input type="checkbox" name="disp[]" value="lun">
                                                    <label>Lunedì</label><br>
                                                    <input type="checkbox" name="disp[]" value="mar">
                                                    <label>Martedì</label><br>
                                                    <input type="checkbox" name="disp[]" value="mer">
                                                    <label>Mercoledì</label><br>
                                                    <input type="checkbox" name="disp[]" value="gio">
                                                    <label>Giovedì</label><br>
                                                    <input type="checkbox" name="disp[]" value="ven">
                                                    <label>Venerdì</label><br>
                                                    <input type="checkbox" name="disp[]" value="sab">
                                                    <label>Sabato</label><br>
                                            ...
                                            <tr>
                                                <td colspan="5" rowspan="1">
                                                    <p>Vuoi ricevere votazioni?</p>
                                                    <input type="radio" name="vuole_voto" value="true" id="radio_si"/>
                                                    <label for="radio_si">Sì</label>
                                                    <br>
                                                    <input type="radio" name="vuole_voto" value="false" id="radio_no"/>
