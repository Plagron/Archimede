...
<header id="cima">
    <div class="header-content">
        <div class="header-content-inner">
            ...
            <h1 id="homeHeading">INFORMAZIONI</h1>
            <hr>
            <a href="#general" class="btn btn-primary btn-xl page-scroll" >Generalità</a>
            <a href="#resp" class="btn btn-primary btn-xl page-scroll" >Responsabilità</a>
            <a href="#promo" class="btn btn-primary btn-xl page-scroll" >Promozioni</a>
        </div>
    </div>
</header>

<section class="bg-primary" id="general">
    <div class="container">
        <div class="row">
...
<selection><h1></h1></selection>

<section class="bg-primary" id="resp">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 text-center">
                <h2 class="section-heading">Responsabilità </h2>
                <hr class="light">
                <p><h3>Studenti</h3></p>
                <p class="text-faded">Sono tenuti a rispettare gli impegni presi con serietà.</p>
                <p class="text-faded">Nell’eventualità di contrattempi sono tenuti a comunicare al professore la loro assenza o accordarsi su eventuali cambiamenti di date o orari d’incontro.</p>
                <p class="text-faded">Non hanno la possibilità di dare lezioni, per fare questo devono essere iscritti come professori.</p>
                <p class="text-faded">I pagamenti potranno essere concordati con i professori.</p>
                <p><h3>Professori</h3></p>
...
<section class="bg-primary" id="promo">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 text-center">
                <h2 class="section-heading">Promozioni</h2>
                <hr class="light">
                <p class="text-faded">Tutti i professori registrati avrenno diritto alle promozioni offerte dalle aziende convenzionate che sono presenti nella home page del sito.</p>
                <p class="text-faded">E’ sufficiente che gli utenti dimostrino,all’azienda a cui richiedono lo sconto, di fare parte essendo iscritti al sito trammite stampa del loro profilo aggiornato con data risalente massimo a un mese prima della presentazione dell’attestato.</p>
